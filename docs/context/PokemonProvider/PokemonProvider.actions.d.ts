...
export declare enum PokemonProviderActionKind {
...
export declare type PokemonProviderAction = {
    type: PokemonProviderActionKind.CHANGE_LOADING;
    isLoading: boolean;
} | {
    type: PokemonProviderActionKind.ERROR;
} | {
    type: PokemonProviderActionKind.UPDATE_FAVORITE_POKEMONS;
